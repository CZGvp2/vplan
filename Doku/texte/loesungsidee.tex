...
\section{Server}
\subsection{Funktionen} % ich
\subsection{Struktur} % ich
\subsection{Web-Sicherheit} % Tim
\subsection{Bearbeiten von Daten} % ich
\paragraph{Ablaufprotokoll} % ich
\paragraph{Konvertieren der Daten} % ich
\subsection{Abrufen von Daten} % ich
\subsection{Fehlerbehandlung} % ich
