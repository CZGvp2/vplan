...
<xsl:template match="haupt">
  ...
  <p>
    <table border="2" class='tablekopf'>
      <tr>
        <th class="thlplanstunde">St.</th>
        <th class="thlplanfach">Fach</th>
        <th class="thlplanlehrer">Lehrer</th>
        <th class="thlplanklasse">Klasse/Kurs</th>
        <th class="thlplanvfach">Fach neu</th>
        <th class="thlplanvlehrer">Lehrer neu</th>
        <th class="thlplanvraum">Raum neu</th>
        <th class="thlplaninfo">Info</th>
      </tr>
...
<xsl:template match="aktion">
  <tr>
    ...
    <td class="tdaktionen"><xsl:value-of select="vfach"/></td>
    <td class="tdaktionen"><xsl:value-of select="vlehrer"/></td>
    <td class="tdaktionen"><xsl:value-of select="vraum"/></td>
